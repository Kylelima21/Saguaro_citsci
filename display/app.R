...
ui <- fluidPage(
  ...
  tags$head(
    ...
    tags$title("Saguaro National Park Citizen Science Display"),
  ...
  tags$body(
    ...
    div(class = "titlebox",
       ...
       h3("Citizen Science Display", class = "subtitle-homepage")
    ),
        ...
        div(class = "intro-box",
            ...
            div(class = "intro-content",
                ...
                div(class = "intro-text",
                    h2("Welcome to the Saguaro National Park citizen science display!"),
                    h3("This display summarizes iNaturalist and eBird records from the last week in Saguaro National Park.
                        ...
                        by citizen science participation. To get involved with a project, visit our website!"),
    ...
    div(class = "about-grid-box",
        ...
        div(class = "about-info-box",
            ...
            br(),br(),
            "This project was made possible in part by Friends of Saguaro National Park.",
            # h4("Code"),
